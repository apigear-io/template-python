...
class StructInterfaceSink(IObjectSink):
    def __init__(self):
        super().__init__()
        self._prop_bool = testbed1_api.StructBool()
        self.on_prop_bool_changed = EventHook()
        self._prop_int = testbed1_api.StructInt()
        self.on_prop_int_changed = EventHook()
        self._prop_float = testbed1_api.StructFloat()
        self.on_prop_float_changed = EventHook()
        self._prop_string = testbed1_api.StructString()
    ...
    def olink_on_init(self, name: str, props: object, node: "ClientNode"):
        ...
        for k in props:
            if k == "propBool":
                v =  testbed1_api.as_struct_bool(props[k])
                self._set_prop_bool(v)
            elif k == "propInt":
                v =  testbed1_api.as_struct_int(props[k])
                self._set_prop_int(v)
            elif k == "propFloat":
                v =  testbed1_api.as_struct_float(props[k])
                self._set_prop_float(v)
            elif k == "propString":
                v =  testbed1_api.as_struct_string(props[k])
...
class StructArrayInterfaceSink(IObjectSink):
    ...
    def set_prop_bool(self, value):
        if self._prop_bool == value:
            return
        self.client.set_remote_property('testbed1.StructArrayInterface/propBool', [testbed1_api.from_struct_bool(_) for _ in value])
    ...
    def set_prop_int(self, value):
        if self._prop_int == value:
            return
        self.client.set_remote_property('testbed1.StructArrayInterface/propInt', [testbed1_api.from_struct_int(_) for _ in value])
    ...
    def set_prop_float(self, value):
        if self._prop_float == value:
            return
        self.client.set_remote_property('testbed1.StructArrayInterface/propFloat', [testbed1_api.from_struct_float(_) for _ in value])
    ...
    def set_prop_string(self, value):
        if self._prop_string == value:
            return
        self.client.set_remote_property('testbed1.StructArrayInterface/propString', [testbed1_api.from_struct_string(_) for _ in value])

    def get_prop_string(self):
        return self._prop_string

    async def func_bool(self, param_bool: list[testbed1_api.StructBool]):
        _param_bool = [testbed1_api.from_struct_bool(struct_bool) for struct_bool in param_bool]
        return await self._invoke("funcBool", [_param_bool])

    async def func_int(self, param_int: list[testbed1_api.StructInt]):
        _param_int = [testbed1_api.from_struct_int(struct_int) for struct_int in param_int]
        return await self._invoke("funcInt", [_param_int])

    async def func_float(self, param_float: list[testbed1_api.StructFloat]):
        _param_float = [testbed1_api.from_struct_float(struct_float) for struct_float in param_float]
        return await self._invoke("funcFloat", [_param_float])

    async def func_string(self, param_string: list[testbed1_api.StructString]):
        _param_string = [testbed1_api.from_struct_string(struct_string) for struct_string in param_string]
        return await self._invoke("funcString", [_param_string])
    ...
    def olink_on_init(self, name: str, props: object, node: "ClientNode"):
        ...
        for k in props:
            if k == "propBool":
                v = [testbed1_api.as_struct_bool(_) for _ in props[k]]
                self._set_prop_bool(v)
            elif k == "propInt":
                v = [testbed1_api.as_struct_int(_) for _ in props[k]]
                self._set_prop_int(v)
            elif k == "propFloat":
                v = [testbed1_api.as_struct_float(_) for _ in props[k]]
                self._set_prop_float(v)
            elif k == "propString":
                v = [testbed1_api.as_struct_string(_) for _ in props[k]]
                self._set_prop_string(v)
        self._on_is_ready.fire()
