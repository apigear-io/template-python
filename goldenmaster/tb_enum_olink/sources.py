...
class EnumInterfaceSource(IObjectSource):
    impl: tb_enum_api.IEnumInterface
    def __init__(self, impl: tb_enum_api.IEnumInterface):
        self.impl = impl
