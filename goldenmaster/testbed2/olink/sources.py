...
class ManyParamInterfaceSource(IObjectSource):
    impl: testbed2.api.IManyParamInterface
    def __init__(self, impl: testbed2.api.IManyParamInterface):
        self.impl = impl
...
class NestedStruct1InterfaceSource(IObjectSource):
    impl: testbed2.api.INestedStruct1Interface
    def __init__(self, impl: testbed2.api.INestedStruct1Interface):
        self.impl = impl
        impl.on_prop1_changed += self.notify_prop1_changed
        impl.on_sig1 += self.notify_sig1
        self._on_linked = EventHook()
    ...
    def olink_collect_properties(self) -> object:
        props = {}
        v = self.impl.get_prop1()
        props["prop1"] = testbed2.api.from_nested_struct1(v)
        return props
...
class NestedStruct2InterfaceSource(IObjectSource):
    impl: testbed2.api.INestedStruct2Interface
    def __init__(self, impl: testbed2.api.INestedStruct2Interface):
        self.impl = impl
        impl.on_prop1_changed += self.notify_prop1_changed
        impl.on_prop2_changed += self.notify_prop2_changed
        impl.on_sig1 += self.notify_sig1
    ...
    def olink_collect_properties(self) -> object:
        ...
        props["prop1"] = testbed2.api.from_nested_struct1(v)
        v = self.impl.get_prop2()
        props["prop2"] = testbed2.api.from_nested_struct2(v)
        return props
...
class NestedStruct3InterfaceSource(IObjectSource):
    impl: testbed2.api.INestedStruct3Interface
    def __init__(self, impl: testbed2.api.INestedStruct3Interface):
        self.impl = impl
        impl.on_prop1_changed += self.notify_prop1_changed
        impl.on_prop2_changed += self.notify_prop2_changed
        impl.on_prop3_changed += self.notify_prop3_changed
    ...
    def olink_collect_properties(self) -> object:
        ...
        props["prop2"] = testbed2.api.from_nested_struct2(v)
        v = self.impl.get_prop3()
        props["prop3"] = testbed2.api.from_nested_struct3(v)
        return props
