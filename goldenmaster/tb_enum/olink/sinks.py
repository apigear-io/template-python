...
class EnumInterfaceSink(IObjectSink):
    ...
    async def func0(self, param0: tb_enum.api.Enum0):
        ...
        def func(args):
            return future.set_result(tb_enum.api.as_enum0(args.value))
    ...
    async def func1(self, param1: tb_enum.api.Enum1):
        ...
        future = asyncio.get_running_loop().create_future()
        def func(args):
            return future.set_result(tb_enum.api.as_enum1(args.value))
    ...
    async def func2(self, param2: tb_enum.api.Enum2):
        ...
        future = asyncio.get_running_loop().create_future()
        def func(args):
            return future.set_result(tb_enum.api.as_enum2(args.value))
    ...
    async def func3(self, param3: tb_enum.api.Enum3):
        ...
        future = asyncio.get_running_loop().create_future()
        def func(args):
            return future.set_result(tb_enum.api.as_enum3(args.value))
