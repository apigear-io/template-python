...
class SameStruct1InterfaceSink(IObjectSink):
    ...
    async def func1(self, param1: tb_same2.api.Struct1):
        ...
        def func(args):
            return future.set_result(tb_same2.api.as_struct1(args.value))
    ...
    def olink_on_init(self, name: str, props: object, node: "ClientNode"):
        ...
        for k in props:
            if k == "prop1":
                v =  tb_same2.api.as_struct1(props[k])
                self._set_prop1(v)
...
class SameStruct2InterfaceSink(IObjectSink):
    ...
    def olink_on_init(self, name: str, props: object, node: "ClientNode"):
        ...
        for k in props:
            if k == "prop1":
                v =  tb_same2.api.as_struct2(props[k])
                self._set_prop1(v)
            elif k == "prop2":
                v =  tb_same2.api.as_struct2(props[k])
                self._set_prop2(v)
...
class SameEnum1InterfaceSink(IObjectSink):
    ...
    async def func1(self, param1: tb_same2.api.Enum1):
        ...
        future = asyncio.get_running_loop().create_future()
        def func(args):
            return future.set_result(tb_same2.api.as_enum1(args.value))
    ...
    def olink_on_init(self, name: str, props: object, node: "ClientNode"):
        ...
        for k in props:
            if k == "prop1":
                v =  tb_same2.api.as_enum1(props[k])
                self._set_prop1(v)
        self._on_is_ready.fire()
    ...
    def olink_on_init(self, name: str, props: object, node: "ClientNode"):
        ...
        for k in props:
            if k == "prop1":
                ...
                v =  tb_same2.api.as_enum2(props[k])
                self._set_prop2(v)
        self._on_is_ready.fire()
