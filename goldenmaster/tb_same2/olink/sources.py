...
class SameStruct1InterfaceSource(IObjectSource):
    impl: tb_same2.api.ISameStruct1Interface
    def __init__(self, impl: tb_same2.api.ISameStruct1Interface):
        self.impl = impl
    ...
    def olink_collect_properties(self) -> object:
        ...
        props["prop1"] = tb_same2.api.from_struct1(v)
        return props
...
class SameStruct2InterfaceSource(IObjectSource):
    impl: tb_same2.api.ISameStruct2Interface
    def __init__(self, impl: tb_same2.api.ISameStruct2Interface):
        self.impl = impl
        impl.on_prop1_changed += self.notify_prop1_changed
    ...
    def olink_collect_properties(self) -> object:
        props = {}
        v = self.impl.get_prop1()
        props["prop1"] = tb_same2.api.from_struct2(v)
        v = self.impl.get_prop2()
        props["prop2"] = tb_same2.api.from_struct2(v)
        return props
...
class SameEnum1InterfaceSource(IObjectSource):
    impl: tb_same2.api.ISameEnum1Interface
    def __init__(self, impl: tb_same2.api.ISameEnum1Interface):
        self.impl = impl
        impl.on_prop1_changed += self.notify_prop1_changed
        impl.on_sig1 += self.notify_sig1
        self._on_linked = EventHook()
    ...
    def olink_collect_properties(self) -> object:
        props = {}
        v = self.impl.get_prop1()
        props["prop1"] = tb_same2.api.from_enum1(v)
        return props
...
class SameEnum2InterfaceSource(IObjectSource):
    impl: tb_same2.api.ISameEnum2Interface
    def __init__(self, impl: tb_same2.api.ISameEnum2Interface):
        self.impl = impl
        impl.on_prop1_changed += self.notify_prop1_changed
        impl.on_prop2_changed += self.notify_prop2_changed
        impl.on_sig1 += self.notify_sig1
    ...
    def olink_collect_properties(self) -> object:
        ...
        props["prop1"] = tb_same2.api.from_enum1(v)
        v = self.impl.get_prop2()
        props["prop2"] = tb_same2.api.from_enum2(v)
        return props
