...
class SameStruct1InterfaceClientAdapter():
    ...
    def set_prop1(self, value):
        if self._prop1 == value:
            return
        topic = "tb.same2/SameStruct1Interface/set/prop1"
        self.client.set_remote_property(topic, tb_same2.api.from_struct1(value))
    ...
    def __set_prop1(self, data):
        value =  tb_same2.api.as_struct1(data)
        if self._prop1 == value:
            return
        self._prop1 = value
...
class SameStruct2InterfaceClientAdapter():
    ...
    def set_prop1(self, value):
        if self._prop1 == value:
            return
        topic = "tb.same2/SameStruct2Interface/set/prop1"
        self.client.set_remote_property(topic, tb_same2.api.from_struct2(value))
    ...
    def set_prop2(self, value):
        if self._prop2 == value:
            return
        topic = "tb.same2/SameStruct2Interface/set/prop2"
        self.client.set_remote_property(topic, tb_same2.api.from_struct2(value))
    ...
    def __set_prop1(self, data):
        value =  tb_same2.api.as_struct2(data)
        if self._prop1 == value:
            return
        self._prop1 = value
        self.on_prop1_changed.fire(self._prop1)
...
class SameEnum1InterfaceClientAdapter():
    ...
    def set_prop1(self, value):
        if self._prop1 == value:
            return
        topic = "tb.same2/SameEnum1Interface/set/prop1"
        self.client.set_remote_property(topic, tb_same2.api.from_enum1(value))
    ...
    def __set_prop1(self, data):
        value =  tb_same2.api.as_enum1(data)
        if self._prop1 == value:
            return
        self._prop1 = value
        self.on_prop1_changed.fire(self._prop1)
...
class SameEnum2InterfaceClientAdapter():
    ...
    def set_prop1(self, value):
        if self._prop1 == value:
            return
        topic = "tb.same2/SameEnum2Interface/set/prop1"
        self.client.set_remote_property(topic, tb_same2.api.from_enum1(value))
    ...
    def set_prop2(self, value):
        if self._prop2 == value:
            return
        topic = "tb.same2/SameEnum2Interface/set/prop2"
        self.client.set_remote_property(topic, tb_same2.api.from_enum2(value))
    ...
    def __set_prop2(self, data):
        value =  tb_same2.api.as_enum2(data)
        if self._prop2 == value:
            return
        self._prop2 = value
        self.on_prop2_changed.fire(self._prop2)
