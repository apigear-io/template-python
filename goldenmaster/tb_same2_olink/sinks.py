...
class SameStruct1InterfaceSink(IObjectSink):
    def __init__(self):
        super().__init__()
        self._prop1 = tb_same2_api.Struct1()
    ...
    async def func1(self, param1: tb_same2_api.Struct1):
    ...
    def olink_on_init(self, name: str, props: object, node: "ClientNode"):
        ...
        for k in props:
            if k == "prop1":
                v =  tb_same2_api.as_struct1(props[k])
                self._set_prop1(v)
...
class SameStruct2InterfaceSink(IObjectSink):
    def __init__(self):
        super().__init__()
        self._prop1 = tb_same2_api.Struct2()
        self.on_prop1_changed = EventHook()
        self._prop2 = tb_same2_api.Struct2()
    ...
    async def func2(self, param1: tb_same2_api.Struct1, param2: tb_same2_api.Struct2):
        _param1 = tb_same2_api.from_struct1(param1)
    ...
    def olink_on_init(self, name: str, props: object, node: "ClientNode"):
        ...
        for k in props:
            if k == "prop1":
                v =  tb_same2_api.as_struct2(props[k])
                self._set_prop1(v)
            elif k == "prop2":
                v =  tb_same2_api.as_struct2(props[k])
                self._set_prop2(v)
...
class SameEnum1InterfaceSink(IObjectSink):
    def __init__(self):
        super().__init__()
        self._prop1 = tb_same2_api.Enum1.VALUE1
        self.on_prop1_changed = EventHook()
        self.on_sig1 = EventHook()
        self._on_is_ready= EventHook()
        self.client = ClientNode.register_sink(self)
    ...
    async def func1(self, param1: tb_same2_api.Enum1):
    ...
    def olink_on_init(self, name: str, props: object, node: "ClientNode"):
        ...
        for k in props:
            if k == "prop1":
                v =  tb_same2_api.as_enum1(props[k])
                self._set_prop1(v)
        self._on_is_ready.fire()
...
class SameEnum2InterfaceSink(IObjectSink):
    def __init__(self):
        ...
        self._prop1 = tb_same2_api.Enum1.VALUE1
        self.on_prop1_changed = EventHook()
        self._prop2 = tb_same2_api.Enum2.VALUE1
        self.on_prop2_changed = EventHook()
        self.on_sig1 = EventHook()
        self.on_sig2 = EventHook()
        self._on_is_ready= EventHook()
    ...
    async def func2(self, param1: tb_same2_api.Enum1, param2: tb_same2_api.Enum2):
        _param1 = tb_same2_api.from_enum1(param1)
    ...
    def olink_on_init(self, name: str, props: object, node: "ClientNode"):
        ...
        for k in props:
            if k == "prop1":
                ...
                v =  tb_same2_api.as_enum2(props[k])
                self._set_prop2(v)
        self._on_is_ready.fire()
