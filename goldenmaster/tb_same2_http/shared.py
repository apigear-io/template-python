...
class SameStruct2InterfaceState(BaseModel):
    prop1: api.Struct2 = Field(None, alias="prop1")
    prop2: api.Struct2 = Field(None, alias="prop2")
...
class SameStruct2InterfaceFunc2Request(BaseModel):
    param1: api.Struct1 = Field(None, alias="param1")
    param2: api.Struct2 = Field(None, alias="param2") 
