...
class SameStruct1Interface(api.ISameStruct1Interface):
    ...
    def func1(self, param1: Struct1):
        ...
        data = requests.post(
            f'{self.url}/tb.same2/SameStruct1Interface/func1',
            req.json()
        )
...
class SameStruct2Interface(api.ISameStruct2Interface):
    ...
    def func1(self, param1: Struct1):
        ...
        data = requests.post(
            f'{self.url}/tb.same2/SameStruct2Interface/func1',
            req.json()
        )
    ...
    def func2(self, param1: Struct1, param2: Struct2):
        ...
        data = requests.post(
            f'{self.url}/tb.same2/SameStruct2Interface/func2',
            req.json()
        )
...
class SameEnum1Interface(api.ISameEnum1Interface):
    ...
    def func1(self, param1: Enum1):
        ...
        data = requests.post(
            f'{self.url}/tb.same2/SameEnum1Interface/func1',
            req.json()
        )
...
class SameEnum2Interface(api.ISameEnum2Interface):
    ...
    def func1(self, param1: Enum1):
        ...
        data = requests.post(
            f'{self.url}/tb.same2/SameEnum2Interface/func1',
            req.json()
        )
    ...
    def func2(self, param1: Enum1, param2: Enum2):
        ...
        data = requests.post(
            f'{self.url}/tb.same2/SameEnum2Interface/func2',
            req.json()
        )
