...
class SimpleInterfaceSource(IObjectSource):
    ...
    def notify_sig_float32(self, param_floa32: float):
        _param_floa32 = utils.base_types.from_float32(param_floa32)
        return RemoteNode.notify_signal("tb.simple.SimpleInterface/sigFloat32", [_param_floa32])
...
class NoOperationsInterfaceSource(IObjectSource):
    impl: tb_simple.api.INoOperationsInterface
    def __init__(self, impl: tb_simple.api.INoOperationsInterface):
        self.impl = impl
        impl.on_prop_bool_changed += self.notify_prop_bool_changed
        impl.on_prop_int_changed += self.notify_prop_int_changed
        impl.on_sig_void += self.notify_sig_void
...
class NoSignalsInterfaceSource(IObjectSource):
    impl: tb_simple.api.INoSignalsInterface
    def __init__(self, impl: tb_simple.api.INoSignalsInterface):
        self.impl = impl
        impl.on_prop_bool_changed += self.notify_prop_bool_changed
        impl.on_prop_int_changed += self.notify_prop_int_changed
        self._on_linked = EventHook()
