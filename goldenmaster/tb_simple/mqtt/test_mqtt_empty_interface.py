...
class TestMqttEmptyInterface:
    ...
    async def setup_mqtt(slef):
        impl = tb_simple.impl.EmptyInterface()
        ...
        serviceAdapter = tb_simple.mqtt.EmptyInterfaceServiceAdapter(impl, service)
        sink = tb_simple.mqtt.EmptyInterfaceClientAdapter(client)
