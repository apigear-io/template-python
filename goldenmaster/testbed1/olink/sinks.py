...
class StructInterfaceSink(IObjectSink):
    ...
    async def func_bool(self, param_bool: testbed1.api.StructBool):
        ...
        def func(args):
            return future.set_result(testbed1.api.as_struct_bool(args.value))
    ...
    async def func_float(self, param_float: testbed1.api.StructFloat):
        ...
        future = asyncio.get_running_loop().create_future()
        def func(args):
            return future.set_result(testbed1.api.as_struct_float(args.value))
    ...
    async def func_string(self, param_string: testbed1.api.StructString):
        ...
        future = asyncio.get_running_loop().create_future()
        def func(args):
            return future.set_result(testbed1.api.as_struct_string(args.value))
