...
class StructArrayInterfaceClientAdapter():
    def __init__(self, client: apigear.mqtt.Client):
        ...
        self.on_prop_string_changed = EventHook()
        self._prop_enum = []
        self.on_prop_enum_changed = EventHook()
        self.on_sig_bool = EventHook()
        self.on_sig_int = EventHook()
        self.on_sig_float = EventHook()
        self.on_sig_string = EventHook()
    ...
    def subscribeForTopics(self):
        ...
        self.subscription_ids.append(self.client.subscribe_for_property("testbed1/StructArrayInterface/prop/propEnum", self.__set_prop_enum))
        ...
        self.subscription_ids.append(self.client.subscribe_for_signal("testbed1/StructArrayInterface/sig/sigEnum",  self.__on_sig_enum_signal))
        self.subscription_ids.append(self.client.subscribe_for_invoke_resp(self.method_topics.resp_topic_func_bool, self.__on_func_bool_resp))
        self.subscription_ids.append(self.client.subscribe_for_invoke_resp(self.method_topics.resp_topic_func_int, self.__on_func_int_resp))
        self.subscription_ids.append(self.client.subscribe_for_invoke_resp(self.method_topics.resp_topic_func_float, self.__on_func_float_resp))
        self.subscription_ids.append(self.client.subscribe_for_invoke_resp(self.method_topics.resp_topic_func_string, self.__on_func_string_resp))
        self.subscription_ids.append(self.client.subscribe_for_invoke_resp(self.method_topics.resp_topic_func_enum, self.__on_func_enum_resp))
    ...
    def __del__(self):
        ...
        self.client.unsubscribe("testbed1/StructArrayInterface/prop/propEnum")
        ...
        self.client.unsubscribe("testbed1/StructArrayInterface/sig/sigEnum")
        self.client.unsubscribe(self.method_topics.resp_topic_func_bool)
        self.client.unsubscribe(self.method_topics.resp_topic_func_int)
        self.client.unsubscribe(self.method_topics.resp_topic_func_float)
        self.client.unsubscribe(self.method_topics.resp_topic_func_string)
        self.client.unsubscribe(self.method_topics.resp_topic_func_enum)
    ...
    def set_prop_enum(self, value):
        if self._prop_enum == value:
            return
        topic = "testbed1/StructArrayInterface/set/propEnum"
        self.client.set_remote_property(topic, [testbed1.api.from_enum0(_) for _ in value])
    ...
    async def func_enum(self, param_enum: list[testbed1.api.Enum0]):
        _param_enum = [testbed1.api.from_enum0(enum0) for enum0 in param_enum]
        args = [_param_enum]
        future = asyncio.get_running_loop().create_future()
        def func(result):
            def set_future_callback():
                future.set_result([testbed1.api.as_enum0(_) for _ in result])
            return self.loop.call_soon_threadsafe(set_future_callback)
        call_id = self.client.invoke_remote(self.method_topics.topic_func_enum, self.method_topics.resp_topic_func_enum, args)
        self.pending_calls.func_enum[call_id] = func
        return await asyncio.wait_for(future, 500)
    ...
    def __set_prop_enum(self, data):
        value = [testbed1.api.as_enum0(_) for _ in data]
        if self._prop_enum == value:
            return
        self._prop_enum = value
        self.on_prop_enum_changed.fire(self._prop_enum)
    ...
    def __on_sig_enum_signal(self, args: list[Any]):
    ...
    class MethodTopics:
        def __init__(self, client_id):
            ...
            self.resp_topic_func_string= self.topic_func_string + "/" + str(client_id) + "/result"
            self.topic_func_enum= "testbed1/StructArrayInterface/rpc/funcEnum"
            self.resp_topic_func_enum= self.topic_func_enum + "/" + str(client_id) + "/result"
...
class StructArray2InterfaceClientAdapter():
    def __init__(self, client: apigear.mqtt.Client):
        self.client = client
        self.on_ready = EventHook()
        self._prop_bool = testbed1.api.StructBoolWithArray()
        self.on_prop_bool_changed = EventHook()
        self._prop_int = testbed1.api.StructIntWithArray()
        self.on_prop_int_changed = EventHook()
        self._prop_float = testbed1.api.StructFloatWithArray()
        self.on_prop_float_changed = EventHook()
        self._prop_string = testbed1.api.StructStringWithArray()
        self.on_prop_string_changed = EventHook()
        self._prop_enum = testbed1.api.StructEnumWithArray()
        self.on_prop_enum_changed = EventHook()
        self.on_sig_bool = EventHook()
        self.on_sig_int = EventHook()
        self.on_sig_float = EventHook()
    ...
    def subscribeForTopics(self):
        self.subscription_ids.append(self.client.subscribe_for_property("testbed1/StructArray2Interface/prop/propBool", self.__set_prop_bool))
        self.subscription_ids.append(self.client.subscribe_for_property("testbed1/StructArray2Interface/prop/propInt", self.__set_prop_int))
        self.subscription_ids.append(self.client.subscribe_for_property("testbed1/StructArray2Interface/prop/propFloat", self.__set_prop_float))
        self.subscription_ids.append(self.client.subscribe_for_property("testbed1/StructArray2Interface/prop/propString", self.__set_prop_string))
        self.subscription_ids.append(self.client.subscribe_for_property("testbed1/StructArray2Interface/prop/propEnum", self.__set_prop_enum))
        self.subscription_ids.append(self.client.subscribe_for_signal("testbed1/StructArray2Interface/sig/sigBool",  self.__on_sig_bool_signal))
        self.subscription_ids.append(self.client.subscribe_for_signal("testbed1/StructArray2Interface/sig/sigInt",  self.__on_sig_int_signal))
        self.subscription_ids.append(self.client.subscribe_for_signal("testbed1/StructArray2Interface/sig/sigFloat",  self.__on_sig_float_signal))
        self.subscription_ids.append(self.client.subscribe_for_signal("testbed1/StructArray2Interface/sig/sigString",  self.__on_sig_string_signal))
        self.subscription_ids.append(self.client.subscribe_for_invoke_resp(self.method_topics.resp_topic_func_bool, self.__on_func_bool_resp))
        self.subscription_ids.append(self.client.subscribe_for_invoke_resp(self.method_topics.resp_topic_func_int, self.__on_func_int_resp))
        self.subscription_ids.append(self.client.subscribe_for_invoke_resp(self.method_topics.resp_topic_func_float, self.__on_func_float_resp))
        self.subscription_ids.append(self.client.subscribe_for_invoke_resp(self.method_topics.resp_topic_func_string, self.__on_func_string_resp))
    ...
    def __del__(self):
        self.client.on_connected -= self.subscribeForTopics
        self.client.on_subscribed -= self.__handle_subscribed
        self.client.unsubscribe("testbed1/StructArray2Interface/prop/propBool")
        self.client.unsubscribe("testbed1/StructArray2Interface/prop/propInt")
        self.client.unsubscribe("testbed1/StructArray2Interface/prop/propFloat")
        self.client.unsubscribe("testbed1/StructArray2Interface/prop/propString")
        self.client.unsubscribe("testbed1/StructArray2Interface/prop/propEnum")
        self.client.unsubscribe("testbed1/StructArray2Interface/sig/sigBool")
        self.client.unsubscribe("testbed1/StructArray2Interface/sig/sigInt")
        self.client.unsubscribe("testbed1/StructArray2Interface/sig/sigFloat")
        self.client.unsubscribe("testbed1/StructArray2Interface/sig/sigString")
        self.client.unsubscribe(self.method_topics.resp_topic_func_bool)
        self.client.unsubscribe(self.method_topics.resp_topic_func_int)
        self.client.unsubscribe(self.method_topics.resp_topic_func_float)
        self.client.unsubscribe(self.method_topics.resp_topic_func_string)
    ...
    def set_prop_bool(self, value):
        if self._prop_bool == value:
            return
        topic = "testbed1/StructArray2Interface/set/propBool"
        self.client.set_remote_property(topic, testbed1.api.from_struct_bool_with_array(value))
    ...
    def set_prop_int(self, value):
        if self._prop_int == value:
            return
        topic = "testbed1/StructArray2Interface/set/propInt"
        self.client.set_remote_property(topic, testbed1.api.from_struct_int_with_array(value))
    ...
    def set_prop_float(self, value):
        if self._prop_float == value:
            return
        topic = "testbed1/StructArray2Interface/set/propFloat"
        self.client.set_remote_property(topic, testbed1.api.from_struct_float_with_array(value))
    ...
    def set_prop_string(self, value):
        if self._prop_string == value:
            return
        topic = "testbed1/StructArray2Interface/set/propString"
        self.client.set_remote_property(topic, testbed1.api.from_struct_string_with_array(value))
    ...
    def set_prop_enum(self, value):
        if self._prop_enum == value:
            return
        topic = "testbed1/StructArray2Interface/set/propEnum"
        self.client.set_remote_property(topic, testbed1.api.from_struct_enum_with_array(value))

    def get_prop_enum(self):
        return self._prop_enum

    async def func_bool(self, param_bool: testbed1.api.StructBoolWithArray):
    ...
    async def func_int(self, param_int: testbed1.api.StructIntWithArray):
    ...
    async def func_float(self, param_float: testbed1.api.StructFloatWithArray):
    ...
    async def func_string(self, param_string: testbed1.api.StructStringWithArray):
    ...
    async def func_enum(self, param_enum: testbed1.api.StructEnumWithArray):
        _param_enum = testbed1.api.from_struct_enum_with_array(param_enum)
        args = [_param_enum]
        future = asyncio.get_running_loop().create_future()
        def func(result):
            def set_future_callback():
    ...
    def __set_prop_bool(self, data):
        value =  testbed1.api.as_struct_bool_with_array(data)
        if self._prop_bool == value:
            return
        self._prop_bool = value
        self.on_prop_bool_changed.fire(self._prop_bool)
    ...
    def __set_prop_int(self, data):
        value =  testbed1.api.as_struct_int_with_array(data)
        if self._prop_int == value:
            return
        self._prop_int = value
        self.on_prop_int_changed.fire(self._prop_int)
    ...
    def __set_prop_float(self, data):
        value =  testbed1.api.as_struct_float_with_array(data)
        if self._prop_float == value:
            return
        self._prop_float = value
        self.on_prop_float_changed.fire(self._prop_float)
    ...
    def __set_prop_string(self, data):
        value =  testbed1.api.as_struct_string_with_array(data)
        if self._prop_string == value:
            return
        self._prop_string = value
        self.on_prop_string_changed.fire(self._prop_string)
    ...
    def __set_prop_enum(self, data):
        value =  testbed1.api.as_struct_enum_with_array(data)
        if self._prop_enum == value:
            return
        self._prop_enum = value
        self.on_prop_enum_changed.fire(self._prop_enum)
    ...
    class MethodTopics:
        def __init__(self, client_id):
            self.topic_func_bool= "testbed1/StructArray2Interface/rpc/funcBool"
            self.resp_topic_func_bool= self.topic_func_bool + "/" + str(client_id) + "/result"
            self.topic_func_int= "testbed1/StructArray2Interface/rpc/funcInt"
            self.resp_topic_func_int= self.topic_func_int + "/" + str(client_id) + "/result"
            self.topic_func_float= "testbed1/StructArray2Interface/rpc/funcFloat"
            self.resp_topic_func_float= self.topic_func_float + "/" + str(client_id) + "/result"
            self.topic_func_string= "testbed1/StructArray2Interface/rpc/funcString"
            self.resp_topic_func_string= self.topic_func_string + "/" + str(client_id) + "/result"
            self.topic_func_enum= "testbed1/StructArray2Interface/rpc/funcEnum"
            self.resp_topic_func_enum= self.topic_func_enum + "/" + str(client_id) + "/result"
