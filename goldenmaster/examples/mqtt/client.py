...
async def main():
    ...
    sink_tb_simpleempty_interface = tb_simple.mqtt.EmptyInterfaceClientAdapter(client)
    ...
    sink_testbed1struct_array2_interface = testbed1.mqtt.StructArray2InterfaceClientAdapter(client)
