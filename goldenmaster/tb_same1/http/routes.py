...
@router.post(
    "/tb_same1/same_struct1_interface/func1", 
...
@router.post(
    "/tb_same1/same_struct2_interface/func1", 
...
@router.post(
    "/tb_same1/same_struct2_interface/func2", 
...
@router.post(
    "/tb_same1/same_enum1_interface/func1", 
...
@router.post(
    "/tb_same1/same_enum2_interface/func1", 
...
@router.post(
    "/tb_same1/same_enum2_interface/func2", 
