...
class SameStruct1Interface(api.ISameStruct1Interface):
    ...
    def func1(self, param1: api.Struct1):
        ...
        data = requests.post(
            f'{self.url}/tb_same1/same_struct1_interface/func1',
            req.json()
        )
...
class SameStruct2Interface(api.ISameStruct2Interface):
    ...
    def func1(self, param1: api.Struct1):
        ...
        data = requests.post(
            f'{self.url}/tb_same1/same_struct2_interface/func1',
            req.json()
        )
    ...
    def func2(self, param1: api.Struct1, param2: api.Struct2):
        ...
        data = requests.post(
            f'{self.url}/tb_same1/same_struct2_interface/func2',
            req.json()
        )
...
class SameEnum1Interface(api.ISameEnum1Interface):
    ...
    def func1(self, param1: api.Enum1):
        ...
        data = requests.post(
            f'{self.url}/tb_same1/same_enum1_interface/func1',
            req.json()
        )
...
class SameEnum2Interface(api.ISameEnum2Interface):
    ...
    def func1(self, param1: api.Enum1):
        ...
        data = requests.post(
            f'{self.url}/tb_same1/same_enum2_interface/func1',
            req.json()
        )
    ...
    def func2(self, param1: api.Enum1, param2: api.Enum2):
        ...
        data = requests.post(
            f'{self.url}/tb_same1/same_enum2_interface/func2',
            req.json()
        )
