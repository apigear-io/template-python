...
from tb.same1 import SameStruct1Interface
from tb.same1 import SameStruct2Interface
from tb.same1 import SameEnum1Interface
from tb.same1 import SameEnum2Interface
