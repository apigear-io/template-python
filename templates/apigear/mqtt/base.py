...
class BaseClient:
    ...
    def __message_handling(self, client, userdata, msg):
        ...
        if callback_wrapper != None:
            ...
            self.logging_func(paho.mqtt.enums.LogLevel.MQTT_LOG_WARNING, f"not handled: {msg.topic}: {msg.payload.decode('utf-8')}")
    ...
    def from_payload(self, decoded_string: str) -> list[Any]:
